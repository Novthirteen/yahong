...
namespace Sconit_CS
{
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            dicModuleControl.Add(BusinessConstants.TRANSFORMER_MODULE_TYPE_OFFLINE2, typeof(UCOffLineFab));
            dicModuleControl.Add(BusinessConstants.TRANSFORMER_MODULE_TYPE_UNITIZATION, typeof(UCUnitization));
            dicModuleControl.Add(BusinessConstants.TRANSFORMER_MODULE_TYPE_SEQUENCEONLINE, typeof(UCSequenceOnline));
            dicModuleControl.Add(BusinessConstants.TRANSFORMER_MODULE_TYPE_SEQUENCEOFFLINE, typeof(UCSequenceOffline));
            ...
            dicModuleControl.Add(BusinessConstants.TRANSFORMER_MODULE_TYPE_TRANSFER, typeof(UCTransfer));
            ...
            dicModuleControl.Add(BusinessConstants.TRANSFORMER_MODULE_TYPE_INSPECT, typeof(UCInspection));

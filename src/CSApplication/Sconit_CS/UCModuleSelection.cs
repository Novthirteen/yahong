    ...
    public partial class UCModuleSelection : UserControl
    {
        ...
        public UCModuleSelection(User user)
        {
            if (user != null)
            {
                ...
                dicModuleSelection.Add(BusinessConstants.TRANSFORMER_MODULE_TYPE_OFFLINE2, new ModuleSelection(btnOffline2, tabProduction, Keys.D7, Keys.NumPad7));
                dicModuleSelection.Add(BusinessConstants.TRANSFORMER_MODULE_TYPE_SEQUENCEONLINE, new ModuleSelection(btnSequenceOnline, tabProduction, Keys.D8, Keys.NumPad8));
                dicModuleSelection.Add(BusinessConstants.TRANSFORMER_MODULE_TYPE_SEQUENCEOFFLINE, new ModuleSelection(btnSequenceOffline, tabProduction, Keys.D9, Keys.NumPad9));
                #endregion

...
namespace com.Sconit.Facility.Service
{
    public interface IFacilityMasterMgr : IFacilityMasterBaseMgr
    {
        ...
        void UpdateFacilityMasterAndCreateFacilityTrans(FacilityMaster facilityMaster, FacilityTrans facilityTrans, string status, string userCode, string taskCode);
        void UpdateFacilityAndCreateFacilityTransAndRepairOrder(FacilityMaster facilityMaster, FacilityTrans facilityTrans, RepairOrder repairOrder,string status);

...
{
    [Transactional]
    public class StartPercentRemindJob : IJob
    {
...
{
    [Transactional]
    public partial class StartPercentRemindJob : com.Sconit.ISI.Service.Batch.Job.StartPercentRemindJob
    {
        public StartPercentRemindJob()
        {
        }
    }
}

...
{
    [Transactional]
    public class FiveSRemindJob : IJob
    {
...
{
    [Transactional]
    public partial class FiveSRemindJob : com.Sconit.ISI.Service.Batch.Job.FiveSRemindJob
    {
        public FiveSRemindJob()
        {
        }
    }
}

...
{
    [Transactional]
    public class ProjectReportJob : IJob
    {
        ...
        {
            taskMgrE.SendTaskSubTypeReport();
        }
    }
}
...
{
    [Transactional]
    public partial class ProjectReportJob : com.Sconit.ISI.Service.Batch.Job.ProjectReportJob
    {
        public ProjectReportJob()
        {
        }
    }
}

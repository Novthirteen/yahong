...
namespace com.Sconit.Service.MasterData.Impl
{
    ...
    public class ItemReferenceMgr : ItemReferenceBaseMgr, IItemReferenceMgr
    {
        ...
        private static IList<ItemReference> cachedAllItemReference;
        ...
        [Transaction(TransactionMode.Unspecified)]
        public IList<ItemReference> GetCacheAllItemReference()
        {
            if (cachedAllItemReference == null)
            {
                cachedAllItemReference = GetAllItemReference();
            }
            else
            {
                //检查Item大小是否发生变化
                ...
                if (count[0] != cachedAllItemReference.Count)
                {
                    cachedAllItemReference = GetAllItemReference();
                }
            }

            return cachedAllItemReference;
        }

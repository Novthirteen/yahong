...
namespace com.Sconit.Service.MasterData
{
    public interface IFlowMgr : IFlowBaseMgr
    {
        ...
        Flow LoadFlow(string code, User user);

        Flow LoadFlow(string code, User user, bool includeFlowDetail);
        ...
        IList<FlowView> GetFlowViews(string flowCode, string flowType);

        FlowView LoadFlowView(string flowCode, string userCode, string locationFromCode, string locationToCode, Item item, List<string> flowTypes);

        FlowView LoadFlowView(string flowCode, string itemCode);

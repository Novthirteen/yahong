...
namespace com.Sconit.Service.MasterData
{
    public interface IOrderMgr
    {
        ...
        IList<OrderHead> ConvertShiftPlanScheduleToOrders(IList<ShiftPlanSchedule> shiftPlanScheduleList, bool isIncludeMultiDetail);

        IList<OrderHead> ConvertShiftPlanScheduleToOrders(IList<ShiftPlanSchedule> shiftPlanScheduleList, decimal leadTime, bool isIncludeMultiDetail);
        ...
        OrderHead TransferFlow2OrderHead(Flow flow, string orderSubType, DateTime startTime);

        void TryUpdateWoLoctrans(string orderNo, bool isReuse);

        IList<OrderHead> ConvertFlowPlanToOrdersPana(IList<FlowPlan> flowPlanList);

        IDictionary<string, decimal> FindRMShortageForWO(string orderNo);
    }
}

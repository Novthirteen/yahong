...
namespace com.Sconit.Service.MasterData
{
    public interface IBillMgr : IBillBaseMgr
    {
        ...
        IList<Bill> CreateBill(Dictionary<string, decimal> itemQty, string partyCode, string transType, User user, DateTime startTime, DateTime endTime, bool isEffTime);
        ...
        void ConfirmBill(string billNo, User user);

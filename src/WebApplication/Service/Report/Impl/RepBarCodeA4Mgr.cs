...
namespace com.Sconit.Service.Report.Impl
{
    ...
    public class RepBarCodeA4Mgr : ReportBaseMgr
    {
        ...
        private void writeContent(string companyCode, string userName, int pageIndex, int num, Hu hu)
        {
            ...
            {
                //画方框
                ICell cell1 = this.GetCell(this.GetRowIndexAbsolute(pageIndex, getRowIndex(2, num)), getColumnIndex(4, num));
                ...
                ICell cell2 = this.GetCell(this.GetRowIndexAbsolute(pageIndex, getRowIndex(3, num)), getColumnIndex(4, num));

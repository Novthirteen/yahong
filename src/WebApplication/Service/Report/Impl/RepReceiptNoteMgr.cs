    ...
    public class RepReceiptNoteMgr : RepTemplate1
    {
        ...
        protected override bool FillValuesImpl(String templateFileName, IList<object> list)
        {
            try
            {
                ...
                IList<ReceiptDetail> receiptDetailList = (List<ReceiptDetail>)list[1];
        ...
        private void FillHead(Receipt Receipt)
        {
            ...
            //制表人
            this.SetRowCell(3, 1, Receipt.CreateUser.CodeName);
            //收货单号:
            ...
            //仓库地点:
            this.SetRowCell(6, 1, Receipt.ShipFrom == null ? string.Empty : Receipt.ShipFrom.Address);
            //收货日期:
            ...
            //收货地点:
            this.SetRowCell(7, 5, Receipt.ShipTo == null ? string.Empty : Receipt.ShipTo.Address);
        }

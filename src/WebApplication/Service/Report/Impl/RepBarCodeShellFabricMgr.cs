            ...
            try
            {
                ...
                foreach (Hu hu in huList)
                {
                    if (hu.Item.Type.Equals("M") || hu.Item.Type.Equals("P")) //成品
                    {
                        ...
                        //疵点数
                        this.SetRowCell(pageIndex, 10, 1, hu.TextField1 == null || hu.TextField1 == string.Empty ? string.Empty : hu.TextField1);
                        //让码数
                        this.SetRowCell(pageIndex, 10, 3, hu.TextField2 == null || hu.TextField2 == string.Empty ? string.Empty : hu.TextField2);
                        // 打印日期

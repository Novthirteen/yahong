...
namespace com.Sconit.Service.Report.Impl
{
    ...
    public class RepPurchaseOrderMgr : RepTemplate1
    {
        ...
        private void FillHead(OrderHead orderHead)
        {
            ...
            //货币:
            this.SetRowCell(8, 8, orderHead.Currency != null ? orderHead.Currency.Code + "[" + orderHead.Currency.Name + "]" : string.Empty);
...
{
    [Transactional]
    public partial class RepPurchaseOrderMgrE : com.Sconit.Service.Report.Impl.RepPurchaseOrderMgr, IReportBaseMgrE
    {

...
namespace com.Sconit.Service.Distribution.Impl
{
    ...
    public class InProcessLocationDetailMgr : InProcessLocationDetailBaseMgr, IInProcessLocationDetailMgr
    {
        ...
        public override void CreateInProcessLocationDetail(InProcessLocationDetail entity)
        {
            if (entity.InProcessLocation.OrderType != BusinessConstants.CODE_MASTER_ORDER_TYPE_VALUE_PRODUCTION)
            {
                base.CreateInProcessLocationDetail(entity);
            }
        }

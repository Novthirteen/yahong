    ...
    public class OrderLocTransViewMgr : OrderLocTransViewBaseMgr, IOrderLocTransViewMgr
    {
        ...
        public IList<OrderLocTransView> GetProdIODataList(string flow, string region, string startDate, string endDate, string item, string userCode, string ioType,string uomCode)
        {
            ...
            criteria.SetProjection(Projections.ProjectionList()
                ...
                .Add(Projections.Sum("PlanQty"))
                .Add(Projections.Sum("OrderQty"))
                .Add(Projections.Sum("RecQty"))
                .Add(Projections.Sum("RejQty"))
                .Add(Projections.Sum("ScrapQty")));
        ...
        public IList<OrderLocTransView> ConvertToList(IList list)
        {
            ...
            if (list != null && list.Count > 0)
            {
                foreach (object obj in list)
                {
                    ...
                    orderLocTransView.PlanQty = (decimal)((object[])obj)[2];
                    orderLocTransView.OrderQty = (decimal)((object[])obj)[3];
                    orderLocTransView.RecQty = (decimal)((object[])obj)[4];
                    orderLocTransView.RejQty = (decimal)((object[])obj)[5];
                    orderLocTransView.ScrapQty = (decimal)((object[])obj)[6];

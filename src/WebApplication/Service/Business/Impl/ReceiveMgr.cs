...
namespace com.Sconit.Service.Business.Impl
{
    public class ReceiveMgr : AbstractBusinessMgr
    {
        ...
        protected override void SetBaseInfo(Resolver resolver)
        {
            ...
            if (resolver.OrderType == BusinessConstants.CODE_MASTER_ORDER_TYPE_VALUE_DISTRIBUTION && resolver.IsCSClient)
            {
                throw new BusinessErrorException("销售类型单据不能在CS终端上收货.");
            }
        }

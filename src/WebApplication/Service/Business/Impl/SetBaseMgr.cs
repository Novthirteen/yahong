...
namespace com.Sconit.Service.Business.Impl
{
    public class SetBaseMgr : ISetBaseMgr
    {
        ...
        public void FillResolverByOrder(Resolver resolver)
        {
            ...
            this.CheckPermission(orderHead.Type, orderHead.PartyFrom.Code, orderHead.PartyTo.Code, user);
        ...
        public void FillResolverByASN(Resolver resolver)
        {
            ...
            //}
            this.CheckPermission(inProcessLocation.OrderType, inProcessLocation.PartyFrom.Code, inProcessLocation.PartyTo.Code, user);
        ...
        public void FillResolverByFlow(Resolver resolver, Flow flow)
        {
            ...
            this.CheckPermission(flow.Type, flow.PartyFrom.Code, flow.PartyTo.Code, user);
            #endregion
        ...
        private void CheckPermission(string type, string partyFrom, string partyto, User user)
        {
            //移库校验任意一方

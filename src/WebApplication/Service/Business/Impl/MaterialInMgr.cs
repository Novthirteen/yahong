    ...
    public class MaterialInMgr : AbstractBusinessMgr
    {
        ...
        protected override void SetBaseInfo(Resolver resolver)
        {
            if (!(resolver.CodePrefix == BusinessConstants.BARCODE_HEAD_FLOW ||
                ...
                resolver.CodePrefix == BusinessConstants.CODE_PREFIX_RECEIPT))
            {
                return;
            }
            ...
            if (resolver.CodePrefix == BusinessConstants.CODE_PREFIX_RECEIPT)
            {
                //Fill
                return;
            }
            ...
            {
                transformer.CurrentQty = locationLotDetailMgrE.GetNotHuLocationLotDetailQty(resolver.LocationFormCode, transformer.ItemCode);
            }
            ...
            resolver.Transformers = resolver.Transformers.OrderByDescending(t => t.CurrentQty).ThenBy(t => t.ItemCode).ToList();

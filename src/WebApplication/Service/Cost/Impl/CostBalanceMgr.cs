...
namespace com.Sconit.Service.Cost.Impl
{
    ...
    public class CostBalanceMgr : CostBalanceBaseMgr, ICostBalanceMgr
    {
        ...
        public void ChangeCostBalance(string item, string costGroupCode, decimal amount, User user)
        {
            ...
            if (costDetailList != null && costDetailList.Count > 0)
            {
                ...
                foreach (CostDetail costDetail in costDetailList)
                {
                    ...
                    ChangeCostBalance(item, costGroupCode, costDetail.CostElement.Code, detailAmount, lastFinanceYear, lastFinanceMonth, user);
                }
            }
        }

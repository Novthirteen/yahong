...
namespace com.Sconit.Utility
{
    ...
    public static class TransformerHelper
    {
        ...
        public static List<Transformer> ConvertOrderLocationTransactionToTransformers(IList<OrderLocationTransaction> orderLocationTransactionList)
        {
            ...
            foreach (OrderLocationTransaction orderLocationTransaction in orderLocationTransactionList.ToList())
            {
                transformers.Add(ConvertOrderLocationTransactionToTransformer(orderLocationTransaction));
            }
            return transformers;
        }
        public static Transformer ConvertOrderLocationTransactionToTransformer(OrderLocationTransaction orderLocationTransaction)
        {
            ...
            transformer.Qty = orderLocationTransaction.OrderDetail.OrderedQty;
            transformer.CurrentQty = orderLocationTransaction.OrderDetail.GoodsReceiptLotSize.HasValue ? orderLocationTransaction.OrderDetail.GoodsReceiptLotSize.Value : 0;
            ...
            transformer.Status = orderLocationTransaction.OrderDetail.OrderHead.Status;
            transformer.StartDate = orderLocationTransaction.OrderDetail.OrderHead.StartDate;
            transformer.Memo = orderLocationTransaction.OrderDetail.Remark;
            return transformer;
        }
        ...
        {
            inProcessLocationDetailList = inProcessLocationDetailList.OrderBy(i => i.OrderLocationTransaction.OrderDetail.Sequence).ToList();
                ...
                foreach (InProcessLocationDetail inProcessLocationDetail in inProcessLocationDetailList)
                {
                    ...
                    foreach (Transformer transformer in transformerList)
                    {
                            ...
                            && inProcessLocationDetail.LotNo == transformer.LotNo)
                        {
                            ...
                            transformer.Qty += transformerDetail.Qty;
                            transformer.CurrentQty += transformerDetail.Qty;
                            isExist = true;
                            break;
                        }
                    }
        ...
        public static List<Transformer> ConvertOrderDetailListToTransformers(IList<OrderDetail> orderDetailList, bool includeOrderTracers)
        {
            List<Transformer> transformers = new List<Transformer>();
            ...
            foreach (OrderDetail orderDetail in orderDetailList.ToList())
            {
                transformers.Add(ConvertOrderDetailToTransformer(orderDetail, includeOrderTracers));
            }
            return transformers;
        ...
        public static Transformer ConvertOrderDetailToTransformer(OrderDetail orderDetail, bool includeOrderTracers)
        {
            ...
            transformer.Sequence = orderDetail.Sequence;
            transformer.Status = orderDetail.OrderHead.Status;
            transformer.StartDate = orderDetail.OrderHead.StartDate;

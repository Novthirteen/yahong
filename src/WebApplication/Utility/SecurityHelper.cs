...
namespace com.Sconit.Utility
{
    public static class SecurityHelper
    {
        ...
        public static void SetPartySearchCriteriaMstr(DetachedCriteria selectCriteria, DetachedCriteria selectCountCriteria, string moduleType, string userCode)
        {
            if (moduleType == BusinessConstants.CODE_MASTER_ORDER_TYPE_VALUE_PROCUREMENT)
            {
                //供货路线
                DetachedCriteria[] pfCrieteria = SecurityHelper.GetPartyPermissionCriteria(userCode,
                   BusinessConstants.CODE_MASTER_PARTY_TYPE_VALUE_SUPPLIER, BusinessConstants.CODE_MASTER_PARTY_TYPE_VALUE_CUSTOMER);
                ...
                selectCriteria.Add(
                    Expression.Or(
                    Expression.And(
                    Expression.Eq("Type", BusinessConstants.CODE_MASTER_ORDER_TYPE_VALUE_TRANSFER),
                    Expression.Or(Expression.Or(Subqueries.PropertyIn("pf.Code", regionCrieteria[0]), Subqueries.PropertyIn("pt.Code", regionCrieteria[0])),
                                  Expression.Or(Subqueries.PropertyIn("pf.Code", regionCrieteria[1]), Subqueries.PropertyIn("pt.Code", regionCrieteria[1])))),
                    Expression.And(
                    Expression.Not(Expression.Eq("Type", BusinessConstants.CODE_MASTER_ORDER_TYPE_VALUE_TRANSFER)),
                    Expression.Or(Subqueries.PropertyIn("pf.Code", pfCrieteria[0]), Subqueries.PropertyIn("pf.Code", pfCrieteria[1])))
                    ));
            ...
            {
                //发货路线
                DetachedCriteria[] pfCrieteria = SecurityHelper.GetPartyPermissionCriteria(userCode, BusinessConstants.CODE_MASTER_PARTY_TYPE_VALUE_CUSTOMER);
                ...
                selectCriteria.Add(
                    ...
                    Expression.And(
                    Expression.Not(Expression.Eq("Type", BusinessConstants.CODE_MASTER_ORDER_TYPE_VALUE_TRANSFER)),
                    Expression.Or(Subqueries.PropertyIn("pt.Code", pfCrieteria[0]), Subqueries.PropertyIn("pt.Code", pfCrieteria[1])))
                    ));
            ...
            else if (moduleType == BusinessConstants.CODE_MASTER_ORDER_TYPE_VALUE_PRODUCTION || moduleType == BusinessConstants.CODE_MASTER_ORDER_TYPE_VALUE_TRANSFER)
            {
                DetachedCriteria[] regionCrieteria = SecurityHelper.GetRegionPermissionCriteria(userCode);
                ...
                selectCriteria.Add(
                    Expression.Or(
                         Expression.Or(Subqueries.PropertyIn("pf.Code", regionCrieteria[0]), Subqueries.PropertyIn("pt.Code", regionCrieteria[0])),
                         Expression.Or(Subqueries.PropertyIn("pf.Code", regionCrieteria[1]), Subqueries.PropertyIn("pt.Code", regionCrieteria[1]))
                ));
        ...
        public static void SetPartySearchCriteriaDet(DetachedCriteria selectCriteria, DetachedCriteria selectCountCriteria, string moduleType, string userCode)
        {
            if (moduleType == BusinessConstants.CODE_MASTER_ORDER_TYPE_VALUE_PROCUREMENT)
            {
                //供货路线
                ...
                selectCriteria.Add(
                    Expression.Or(
                    Expression.And(
                    Expression.Eq("o.Type", BusinessConstants.CODE_MASTER_ORDER_TYPE_VALUE_TRANSFER),
                    Expression.Or(Expression.Or(Subqueries.PropertyIn("pf.Code", regionCrieteria[0]), Subqueries.PropertyIn("pt.Code", regionCrieteria[0])),
                                  Expression.Or(Subqueries.PropertyIn("pf.Code", regionCrieteria[1]), Subqueries.PropertyIn("pt.Code", regionCrieteria[1])))),
                    Expression.And(
                    Expression.Not(Expression.Eq("o.Type", BusinessConstants.CODE_MASTER_ORDER_TYPE_VALUE_TRANSFER)),
                    Expression.Or(Subqueries.PropertyIn("pf.Code", pfCrieteria[0]), Subqueries.PropertyIn("pf.Code", pfCrieteria[1])))
                    ));
        ...
        /// <param name="selectCountCriteria"></param>
        /// <param name="moduleType"></param>
        /// <param name="userCode"></param>
        public static void SetPartySearchCriteriaMstr1(DetachedCriteria selectCriteria, DetachedCriteria selectCountCriteria, string moduleType, string userCode)
        {
            if (moduleType == BusinessConstants.CODE_MASTER_ORDER_TYPE_VALUE_PROCUREMENT)
            {
                //供货路线
                ...
                selectCriteria.Add(
                    ...
                    Expression.Or(Expression.Or(Subqueries.PropertyIn("pf.Code", regionCrieteria[0]), Subqueries.PropertyIn("pt.Code", regionCrieteria[0])),
                                  Expression.Or(Subqueries.PropertyIn("pf.Code", regionCrieteria[1]), Subqueries.PropertyIn("pt.Code", regionCrieteria[1])))),
                    Expression.And(
                    Expression.Not(Expression.Eq("OrderType", BusinessConstants.CODE_MASTER_ORDER_TYPE_VALUE_TRANSFER)),
                    Expression.Or(Subqueries.PropertyIn("pf.Code", pfCrieteria[0]), Subqueries.PropertyIn("pf.Code", pfCrieteria[1])))
                    ));

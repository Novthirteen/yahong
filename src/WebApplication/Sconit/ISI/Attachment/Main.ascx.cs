...
public partial class ISI_Attachment_Main : com.Sconit.Web.MainModuleBase
{
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        selectCriteria.Add(Expression.Not(Expression.Eq("ModuleType", typeof(ResSop).FullName)));
        selectCountCriteria.Add(Expression.Not(Expression.Eq("ModuleType", typeof(ResSop).FullName)));

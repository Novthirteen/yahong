<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Attachment.ascx.cs" Inherits="ISI_Attachment_Attachment" %>
...
<fieldset>
    ...
    <asp:GridView ID="GV_List_Attachment" runat="server" OnRowDataBound="GV_List_RowDataBound"
        AutoGenerateColumns="false" OnDataBinding="GV_List_OnDataBinding">
        <Columns>

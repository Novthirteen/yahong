<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Main.ascx.cs" Inherits="ISI_Attachment_Main" %>
...
<fieldset>
    <table class="mtable">
        <tr>
            <td class="td01">
                <asp:Literal ID="lblTaskCode" runat="server" Text="${ISI.Attachment.TaskCode}:" />
            </td>
            <td class="td02">

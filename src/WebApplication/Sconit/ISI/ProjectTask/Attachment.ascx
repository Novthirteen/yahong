<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Attachment.ascx.cs" Inherits="ISI_ProjectTask_Attachment" %>
...
<fieldset>
    <legend>${Common.Button.Upload}</legend>
    <table class="mtable">
        <tr>
            <td class="td01"></td>
...
<fieldset>
    <legend id="lgd">${ISI.ProjectTask.Attachment}</legend>

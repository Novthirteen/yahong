...
public partial class ISI_Scheduling_Mstr : MainModuleBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        this.ucEdit.IsSpecial = this.IsSpecial;
        this.ucNew.IsSpecial = this.IsSpecial;
        this.ucSearch.IsSpecial = this.IsSpecial;
        this.ucList.IsSpecial = this.IsSpecial;
        if (!IsPostBack)
        {

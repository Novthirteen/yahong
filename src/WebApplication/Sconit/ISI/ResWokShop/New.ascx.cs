...
public partial class Modules_ISI_ResWokShop_New : NewModuleBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //Controls_TextBox tbLocFrom = (Controls_TextBox)this.FV_ResWokShop.FindControl("tbLocFrom");
    ...
    protected void ODS_ResWokShop_Inserting(object sender, ObjectDataSourceMethodEventArgs e)
    {
    ...
    protected void ODS_ResWokShop_Inserted(object sender, ObjectDataSourceStatusEventArgs e)
    {
        if (e.Exception != null)
        {
    ...
    {
        ((TextBox)(this.FV_ResWokShop.FindControl("tbCode"))).Text = string.Empty;
        ((TextBox)(this.FV_ResWokShop.FindControl("tbName"))).Text = string.Empty;
        ((Controls_TextBox)(this.FV_ResWokShop.FindControl("tbParentCode"))).Text = string.Empty;
        ((CheckBox)(this.FV_ResWokShop.FindControl("cbIsActive"))).Checked = true;

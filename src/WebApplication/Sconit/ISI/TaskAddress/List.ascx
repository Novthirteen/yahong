<%@ Control Language="C#" AutoEventWireup="true" CodeFile="List.ascx.cs" Inherits="ISI_TaskAddress_List" %>
...
<fieldset>
    <div class="GridView">
        <cc1:GridView ID="GV_List" runat="server" AutoGenerateColumns="False" DataKeyNames="Code"
            ...
            <Columns>
                <asp:BoundField DataField="Code" HeaderText="${ISI.TaskAddress.Code}" SortExpression="Code" />
                <asp:BoundField DataField="Desc" HeaderText="${Common.Business.Description}" SortExpression="Desc" />
                <asp:BoundField DataField="Seq" HeaderText="${ISI.TaskAddress.Sequence}" SortExpression="Seq" />
                <asp:TemplateField HeaderText="${ISI.TaskAddress.Parent}" SortExpression="Parent.Code">
                    <ItemTemplate>

...
public partial class ISI_Bill_Main : MainModuleBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            if (this.ModuleParameter.ContainsKey("PSIType"))
            {
                this.PSIType = this.ModuleParameter["PSIType"];
            }

            this.ucNew.PSIType = this.PSIType;
            this.ucEdit.PSIType = this.PSIType;
            this.ucList.PSIType = this.PSIType;
            this.ucSearch.PSIType = this.PSIType;

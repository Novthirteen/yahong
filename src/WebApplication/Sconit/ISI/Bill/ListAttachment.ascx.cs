...
public partial class ISI_Bill_ListAttachment : com.Sconit.Web.MainModuleBase
{
    ...
    {
        this.GV_List_Attachment.DataSource = this.TheAttachmentDetailMgr.GetAttachment(this.TaskCode, typeof(Mould).FullName);

...
public partial class ISI_Summary_Main : MainModuleBase
{
    ...
    void Search_Render(object sender, EventArgs e)
    {
        ...
        this.ucList.IsNoSubmit = (bool)((object[])sender)[2];
        this.ucList.SummaryDate = (string)((object[])sender)[3];
    ...
    void ListEdit_Render(object sender, EventArgs e)
    {
        ...
        this.ucSearch.Visible = false;
        this.ucList.Visible = false;
        this.TheSummaryMgr.ApproveSummary((string)sender, this.CurrentUser);
        this.ucEdit.InitPageParameter((string)sender);
    }

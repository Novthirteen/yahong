...
<table cellspacing='0' cellpadding='4' rules='all' border='1' style='border-collapse:collapse;'>
<tr style='color: #FFFFFF;background-color: #BBE0FD;font-weight: bold;line-height: 150%;'><th scope='col'>物料号</th><th scope='col'>物料描述</th><th scope='col'>单位</th><th scope='col'>订单数</th></tr>

...
public partial class Cost_Report_Bill_Main : MainModuleBase
{
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            sqlParam[2] = new SqlParameter("@p2", Convert.ToDateTime(this.tbEndTime.Text));
            ...
            sql += @" group by party.code,party.name,actbill.Currency ";
    ...
    protected void tbFinanceYear_TextChange(object sender, EventArgs e)
    {
        ...
        this.tbStartTime.Text = financeCalendar.StartDate.ToString("yyyy-MM-dd HH:mm:ss");
        this.tbEndTime.Text = financeCalendar.EndDate.ToString("yyyy-MM-dd HH:mm:ss");
    }
}

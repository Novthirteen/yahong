...
public partial class Cost_CostAllocateMethod_Edit : EditModuleBase
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        CostAllocateMethod costAllocateMethod = TheCostAllocateMethodMgr.LoadCostAllocateMethod(this.Id);
        ...
        try
        {
            ...
            TheCostAllocateMethodMgr.UpdateCostAllocateMethod(costAllocateMethod);

...
<div id="divFV" runat="server">
    <asp:FormView ID="FV_FinanceCalendar" runat="server" DataSourceID="ODS_FinanceCalendar" DefaultMode="Edit"
        Width="100%" DataKeyNames="Id" OnDataBound="FV_FinanceCalendar_DataBound">
        <EditItemTemplate>
            <fieldset>
                <table class="mtable">
                    <tr>
...
<asp:ObjectDataSource ID="ODS_FinanceCalendar" runat="server" TypeName="com.Sconit.Web.FinanceCalendarMgrProxy"
    DataObjectTypeName="com.Sconit.Entity.MasterData.FinanceCalendar" UpdateMethod="UpdateFinanceCalendar"  OnUpdating="ODS_FinanceCalendar_Updating"
    OnUpdated="ODS_FinanceCalendar_Updated" SelectMethod="LoadFinanceCalendar" DeleteMethod="DeleteFinanceCalendar"
    OnDeleted="ODS_FinanceCalendar_Deleted">
    <SelectParameters>

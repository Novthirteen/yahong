    ...
    <asp:FormView ID="FV_Edit" runat="server" DataSourceID="ODS_FV" DefaultMode="ReadOnly"
        ...
        <ItemTemplate>
            <table class="mtable">
                ...
                <tr>
                    <td class="td01">
                        <asp:Literal ID="ltlCiDian" runat="server" Text="${Reports.CiDian}:" />
                    </td>
                    <td class="td02">
                        <asp:TextBox  ID="tbCiDian" runat="server" ReadOnly="true" Text='<%# Bind("TextField1") %>' />
                    </td>
                    <td class="td01">
                        <asp:Literal ID="ltlRangMa" runat="server" Text="${Reports.RangMa}:" />
                    </td>
                    <td class="td02">
                        <asp:TextBox ID="tbRangMa" runat="server" ReadOnly="true" Text='<%# Bind("TextField2") %>' />
                    </td>
                </tr>
                <tr>
                    <td class="td01">
                    ...
                    <td class="td01">
                        <asp:Literal ID="ltlEmployeeNo" runat="server" Text="${Reports.EmployeeNo}:" />
                    </td>
                    <td class="td02">
                        <asp:TextBox ID="tbEmployeeNo" runat="server" ReadOnly="true" Text='<%# Bind("TextField4") %>' />
                    </td>
                </tr>
            </table>
        </ItemTemplate>

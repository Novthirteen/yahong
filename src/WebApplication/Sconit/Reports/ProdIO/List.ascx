    ...
    <div class="GridView">
        <sc1:GridView ID="GV_List" runat="server" AutoGenerateColumns="False" SeqNo="0" SeqText="No."
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="${MasterData.Item.ItemCategory}" SortExpression="Item.ItemCategory">
                    <ItemTemplate>
                        <asp:Label ID="lblItemCategory" runat="server" Text='<%# Eval("Item.ItemCategory.Code")%>' />
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="${MasterData.Flow.LocTrans.Out}(物料号/描述/单位/理论用量/实际用量)">
                    <ItemTemplate>

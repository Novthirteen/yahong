        ...
        <sc1:GridView ID="GV_List" runat="server" AutoGenerateColumns="False" DataKeyNames="Id"
            ...
            <Columns>
                <asp:TemplateField HeaderText="${Common.Business.EffDate}" SortExpression="EffDate">
                    <ItemTemplate>
                        <asp:Label ID="lblEffDate" runat="server" Text='<%# Eval("EffDate","{0:yyyy-MM-dd HH:mm}")%>' />
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="${Common.Business.CreateTime}" SortExpression="CreateDate">
                    <ItemTemplate>
                        <asp:Label ID="lblEffDate" runat="server" Text='<%# Eval("CreateDate","{0:yyyy-MM-dd HH:mm:ss}")%>' />
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="${Visualization.GoodsTraceability.TransType}" SortExpression="TransType">
                    <ItemTemplate>
                        <sc1:CodeMstrLabel ID="lblTransType" runat="server" Code="LocTransType" Value='<%# Bind("TransType") %>' />
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="${Common.From}" SortExpression="PartyFromName">
                    <ItemTemplate>
                        <asp:Label ID="lblSupplier" runat="server" Text='<%# Eval("PartyFrom")%>' ToolTip='<%# Eval("PartyFromName")%>' />
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="${Common.To}" SortExpression="PartyToName">
                    <ItemTemplate>
                        <asp:Label ID="lblCustomer" runat="server" Text='<%# Eval("PartyTo")%>' ToolTip='<%# Eval("PartyToName")%>'/>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="${Common.Business.Location}" SortExpression="Loc">
                    <ItemTemplate>
                        <asp:Label ID="lblLocation" runat="server" Text='<%# Eval("Loc")%>' ToolTip='<%# Eval("LocName")%>'/>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="${Common.Business.CreateUser}" SortExpression="CreateUser">
                    <ItemTemplate>
                        <asp:Label ID="lblCreateUser" runat="server" Text='<%# Eval("CreateUser.Name")%>' ToolTip='<%# Eval("CreateUser.Code")%>' />
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </sc1:GridView>

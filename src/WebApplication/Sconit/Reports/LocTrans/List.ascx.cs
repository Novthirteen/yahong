...
public partial class Reports_LocTrans_List : ReportModuleBase
{
    ...
    protected override void SetCriteria()
    {
        ...
        projectionList.Add(Projections.GroupProperty("CreateDate").As("CreateDate"));
        if (this._criteriaParam.ClassifiedDate)
        {
            CriteriaHelper.SetStartDateCriteria(selectCriteria, "CreateDate", this._criteriaParam);
            CriteriaHelper.SetEndTimeCriteria(selectCriteria, "CreateDate", this._criteriaParam);
        }
        else
        {
            CriteriaHelper.SetStartDateCriteria(selectCriteria, "EffDate", this._criteriaParam);
            CriteriaHelper.SetEndTimeCriteria(selectCriteria, "EffDate", this._criteriaParam);
        }

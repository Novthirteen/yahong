...
public partial class Reports_LocTrans_Search : SearchModuleBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            this.tbStartDate.Text = DateTime.Today.AddDays(-1).ToString("yyyy-MM-dd HH:mm");
            this.tbEndDate.Text = DateTime.Today.ToString("yyyy-MM-dd HH:mm");
        }
    }
    ...
    private CriteriaParam CollectParam()
    {
        ...
        criteriaParam.ClassifiedDate = this.rblList.SelectedIndex == 0;

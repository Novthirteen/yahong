<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Main.ascx.cs" Inherits="Report_Reuse_Main" %>
        ...
        <tr>
            ...
            <td class="td02">
                <asp:RadioButtonList ID="rblListFormat" runat="server" RepeatDirection="Horizontal">
                    <asp:ListItem Text="原材料" Value="ISS-WO" Selected="True" />
                    <asp:ListItem Text="成品" Value="RCT-WO" />
                </asp:RadioButtonList>
            </td>
            <td>
            </td>

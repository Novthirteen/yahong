<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Main.ascx.cs" Inherits="Reports_WorkHours_Main" %>
...
<fieldset>
    <table class="mtable">
        <tr>
            ...
            <td class="td02">
                <uc3:textbox ID="tbItemCategory" runat="server" Visible="true" DescField="Description" Width="280"
        ...
        <tr>
            ...
            <td class="td02">
                <uc3:textbox ID="tbFlow" runat="server" DescField="Description" Width="280"

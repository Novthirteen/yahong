...
<fieldset>
    <table class="mtable">
        ...
        <tr>
            ...
            <td class="td02">
                <asp:CheckBox ID="cbPlan" runat="server" Checked="false" Text="${MasterData.Location.VisiblePan}" />
                <asp:CheckBox ID="cbIsConcentration" runat="server" Checked="false" Text="${Common.Business.IsConcentration}" />
            </td>
        </tr>
        <tr>
            <td class="td01">

...
<head runat="server">
    <style type="text/css">
        ...
        .login_bg_div
        {
            ...
            height: 512px;
            background-repeat: no-repeat;
            background: url(UpLoad/LoginImages/1.jpg);
        }
        .divThemeSelect
        {
            float: left;
...
<body scroll="no" style="background-color: #B2BDC4;">
    ...
    <div class="login_top_stripe">
        ...
        <asp:HyperLink ID="Code128" runat="server" Text="<%$Resources:Language,FontCode128%>"
            ForeColor="Wheat" Target="_blank" NavigateUrl="~/Reports/Templates/ExcelTemplates/Fonts.rar" />
        |
        <asp:HyperLink ID="hlClient" runat="server" Text="<%$Resources:Language,OfflineTerminal%>"
            ForeColor="Wheat" Target="_blank" NavigateUrl="~/Sconit_CS/publish.htm" />
    </div>
    <div class="login_bg">

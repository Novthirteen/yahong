        ...
        <cc1:GridView ID="GV_List" runat="server" AutoGenerateColumns="False" DataKeyNames="IpNo"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="${MasterData.Order.OrderHead.WindowTime}">
                    <ItemTemplate>
                        <asp:Label ID="lblWinTime" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "WindowTime", "{0:yyyy-MM-dd HH:mm}")%>' />
                    </ItemTemplate>
                </asp:TemplateField>
        ...
        <cc1:GridView ID="GV_List_Detail" runat="server" AutoGenerateColumns="False" DataKeyNames="Id"
            ...
            <Columns>
                <asp:TemplateField HeaderText="${InProcessLocation.IpNo}" SortExpression="InProcessLocation">
                    <ItemTemplate>
                        <cc1:LinkButton ID="lbtnView" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "InProcessLocation.IpNo")%>'
                            Text='<%# DataBinder.Eval(Container.DataItem, "InProcessLocation.IpNo")%>' OnClick="lbtnView_Click"
                            FunctionId="ViewAsn">
                        </cc1:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="${Warehouse.LocTrans.RefOrderNo}" SortExpression="InProcessLocation.ReferenceOrderNo">
                    <ItemTemplate>
                        <asp:Label ID="lblReferenceOrderNo" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "InProcessLocation.ReferenceOrderNo")%>' />
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="${Warehouse.LocTrans.ExtOrderNo}" SortExpression="InProcessLocation.ExternalOrderNo">
                    <ItemTemplate>
                        <asp:Label ID="lblExternalOrderNo" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "InProcessLocation.ExternalOrderNo")%>' />
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="${Common.Business.LotNo}" SortExpression="InProcessLocationDetail.LotNo">
                    <ItemTemplate>

    ...
    <fieldset>
        ...
        <table class="mtable">
            ...
            <tr>
                ...
                <td class="td02">
                    <div class="buttons">
                        <cc1:Button ID="btnInsert" runat="server" Text="${Common.Button.Save}" OnClick="btnSave_Click"
                            ValidationGroup="vgSave" CssClass="apply"  FunctionId="Page_EditItem"/>
                        <cc1:Button ID="btnDelete" runat="server" Text="${Common.Button.Delete}" OnClick="btnDelete_Click"
                            CssClass="delete"  FunctionId="Page_EditItem"/>

        ...
        <cc1:GridView ID="GV_List" runat="server" AutoGenerateColumns="False" DataKeyNames="Code"
            ...
            <Columns>
                ...
                <%--<asp:TemplateField HeaderText="${MasterData.Item.Location}" SortExpression="Location">
                    ...
                    <asp:TemplateField HeaderText="${MasterData.Item.ItemCategory}" SortExpression="Location">
                    <ItemTemplate>
                        <%# DataBinder.Eval(Container.DataItem, "ItemCategory.Description")%>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:BoundField DataField="Container" HeaderText="${MasterData.Item.Container}" SortExpression="Container" />
                ...
                <asp:TemplateField HeaderText="${Common.GridView.Action}">
                    <ItemTemplate>
                        ...
                        <cc1:LinkButton ID="lbtnDelete" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "Code") %>'
                            Text="${Common.Button.Delete}" OnClick="lbtnDelete_Click" OnClientClick="return confirm('${Common.Button.Delete.Confirm}')" FunctionId="Page_EditItem" />
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </cc1:GridView>

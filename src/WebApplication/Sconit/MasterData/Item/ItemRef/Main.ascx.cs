...
public partial class MasterData_Item_ItemRef_Main : MainModuleBase
{
    ...
    public void InitPageParameter(string code)
    {
        ...
        this.GV_List.Columns[9].Visible = this.CurrentUser.PagePermission.Select(p => p.Code).Contains(BusinessConstants.PERMISSION_PAGE_MASTERDATA_VALUE_PAGE_EDITITEM);

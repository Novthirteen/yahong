...
public partial class MasterData_Item_New : NewModuleBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        ((Controls_TextBox)(this.FV_Item.FindControl("tbParty"))).ServiceParameter = "string:" + this.CurrentUser.Code;
    }
    ...
    public void PageCleanup()
    {
        ...
        ((CheckBox)(this.FV_Item.FindControl("cbIsFreeze"))).Checked = false;

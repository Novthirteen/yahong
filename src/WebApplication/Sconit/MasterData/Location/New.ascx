        ...
        <InsertItemTemplate>
            <fieldset>
                ...
                <table class="mtable">
                    ...
                    <tr>
                        <td class="td01">
                            <asp:Literal ID="ltlIsFreeze" runat="server" Text="${MasterData.Location.IsFreeze}:" />
                        </td>
                        <td class="td02">
                            <asp:CheckBox ID="cbIsFreeze" runat="server" Checked='<%#Bind("IsFreeze") %>' />
                        </td>
                         <td class="td01">
                            <asp:Literal ID="ltlIsMrp" runat="server" Text="MRP:" />
                        </td>
                        <td class="td02">

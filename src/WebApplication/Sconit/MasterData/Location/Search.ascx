...
<fieldset>
    <table class="mtable">
        ...
        <tr>
            ...
            <td class="td02">
                <asp:CheckBox ID="cbIsActive" runat="server" Checked="true" Text="${MasterData.Location.IsActive}" />
            </td>
            <td class="td01">
            </td>
            <td class="td02">
                <asp:CheckBox ID="cbIsFreeze" runat="server" Text="${MasterData.Location.IsFreeze}" />
            </td>
        </tr>
        <tr>
            <td colspan="3">

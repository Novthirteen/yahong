...
public partial class MasterData_Bom_BomDetail_Search : SearchModuleBase
{
    ...
    protected override void DoSearch()
    {
        ...
        if (SearchEvent != null)
        {
            ...
            {
                selectCriteria.Add(Expression.Eq("Bom.Code", parcode));
                selectCountCriteria.Add(Expression.Eq("Bom.Code", parcode));
            }
            if (compcode != string.Empty)
            {
                selectCriteria.Add(Expression.Eq("Item.Code", compcode));
                selectCountCriteria.Add(Expression.Eq("Item.Code", compcode));
            }

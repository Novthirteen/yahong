...
<div class="AjaxClass  ajax__tab_default">
    <div class="ajax__tab_header">
        ...
        id='tab_bom' runat="server" visible="false"><span class='ajax__tab_outer'><span class='ajax__tab_inner'><span 
        ...
        id='tab_bomdetail' runat="server" visible="false"><span class='ajax__tab_outer'><span class='ajax__tab_inner'><span 

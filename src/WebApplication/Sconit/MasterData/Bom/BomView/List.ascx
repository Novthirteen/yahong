    ...
    <div class="GridView">
        <asp:GridView ID="GV_List" runat="server" AutoGenerateColumns="false" OnRowDataBound="GV_List_RowDataBound">
            <Columns>
                ...
                <asp:BoundField DataField="CompDesc" HeaderText="${Common.Business.Description}"
                    SortExpression="CompDesc" />
                <asp:BoundField DataField="CompUom" HeaderText="${Common.Business.Uom}" SortExpression="CompUom" />
                <asp:BoundField DataField="CalculatedQty" HeaderText="${MasterData.Bom.RateQty}"
                    SortExpression="CalculatedQty" DataFormatString="{0:0.########}" />

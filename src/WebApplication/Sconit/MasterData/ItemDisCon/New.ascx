            ...
            <fieldset>
                ...
                <table class="mtable">
                    ...
                    <tr>
                        ...
                        <td class="td02">
                            <asp:TextBox ID="tdItem" runat="server" Text=''  CssClass="inputRequired"/>
                        ...
                        <td class="td02">
                            <asp:TextBox ID="tdDiscontinueItem" runat="server" Text='' CssClass="inputRequired" />
...
<asp:ObjectDataSource ID="ODS_ItemDisCon" runat="server" TypeName="com.Sconit.Web.ItemDisConMgrProxy"
    ...
    OnInserted="ODS_ItemDisCon_Inserted" OnInserting="ODS_ItemDisCon_Inserting"></asp:ObjectDataSource>
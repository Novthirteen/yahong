...
public partial class MasterData_ItemDisCon_New : NewModuleBase
{
    ...
    public void PageCleanup()
    {
        ...
        ((TextBox)(this.FV_ItemDisCon.FindControl("tdItem"))).Text = string.Empty;
        ((TextBox)(this.FV_ItemDisCon.FindControl("tdDiscontinueItem"))).Text = string.Empty;
    ...
    protected void ODS_ItemDisCon_Inserting(object sender, ObjectDataSourceMethodEventArgs e)
    {
        ...
        itemDiscontinue.DiscontinueItem = TheItemMgr.LoadItem(item);

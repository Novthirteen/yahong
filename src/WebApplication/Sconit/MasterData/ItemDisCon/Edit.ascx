        ...
        <EditItemTemplate>
            <fieldset>
                ...
                <table class="mtable">
                    <tr>
                        <td class="td01">
                            <asp:Literal ID="lblId" runat="server" Text="id" />
                        </td>
                        <td class="td02">
                        ...
                        <td class="td02">
                            ...
                            <asp:CustomValidator ID="CustomValidator2" runat="server" ControlToValidate="tdBom" ErrorMessage="${MasterData.ItemDisCon.CodeExist3}"
                                Display="Dynamic" ValidationGroup="vgSave" OnServerValidate="checkItemExists3" />
                        </td>
                    </tr>
                    <tr>
                        <td class="td01">
                        ...
                        <td class="td02">
                            <asp:TextBox ID="tdItem" runat="server" CssClass="inputRequired" />
                            <asp:RequiredFieldValidator ID="requiredFieldValidatorItem" runat="server" ErrorMessage="${MasterData.ItemDisCon.Item}${MasterData.ItemDisCon.Empty}"
                                Display="Dynamic" ControlToValidate="tdItem" ValidationGroup="vgSave" />
                        ...
                        <td class="td02">
                            <asp:TextBox ID="tdDiscontinueItem" runat="server" CssClass="inputRequired" />
                            <asp:RequiredFieldValidator ID="DiscontinueItem" runat="server" ErrorMessage="${MasterData.ItemDisCon.DisconItem}${MasterData.ItemDisCon.Empty}"
                                Display="Dynamic" ControlToValidate="tdDiscontinueItem" ValidationGroup="vgSave" />
                            <asp:CustomValidator ID="CustomValidator1" runat="server" ControlToValidate="tdDiscontinueItem" ErrorMessage="${MasterData.ItemDisCon.CodeExist2}"
                                Display="Dynamic" ValidationGroup="vgSave" OnServerValidate="checkItemExists1" />
                        </td>
                    </tr>
                    <tr>
                        <td class="td01">
                    ...
                    <tr>
                        ...
                        <td class="td02">
                            <asp:TextBox ID="tbStartDate" runat="server" Text='<%# Bind("StartDate") %>' CssClass="inputRequired"  onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})" />

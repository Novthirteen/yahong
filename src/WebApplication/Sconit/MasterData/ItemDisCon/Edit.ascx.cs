...
public partial class MasterData_ItemDisCon_Edit : EditModuleBase
{
    ...
    protected void FV_ItemDisCon_DataBound(object sender, EventArgs e)
    {
        ...
        if (itemDiscontinue != null)
        {
            ...
            ((TextBox)(this.FV_ItemDisCon.FindControl("tdItem"))).Text = (itemDiscontinue.Item) == null ? string.Empty : itemDiscontinue.Item.Code;
            ((TextBox)(this.FV_ItemDisCon.FindControl("tdDiscontinueItem"))).Text = (itemDiscontinue.DiscontinueItem == null) ? string.Empty : itemDiscontinue.DiscontinueItem.Code;
    ...
    {
        string code = ((TextBox)(this.FV_ItemDisCon.FindControl("tdItem"))).Text;
    ...
    {
        string code = ((TextBox)(this.FV_ItemDisCon.FindControl("tdDiscontinueItem"))).Text;
    ...
    protected void ODS_ItemDisCon_Updating(object sender, ObjectDataSourceMethodEventArgs e)
    {
        ...
        string item = ((TextBox)(this.FV_ItemDisCon.FindControl("tdItem"))).Text.Trim();
        ItemDisCon.Item = TheItemMgr.LoadItem(item);
        string discontinueItem = ((TextBox)(this.FV_ItemDisCon.FindControl("tdDiscontinueItem"))).Text.Trim();

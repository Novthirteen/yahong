...
public partial class MasterData_User_Edit : EditModuleBase
{
    ...
    protected void btnUpdatePassword_Click(object sender, EventArgs e)
    {
        ...
        TextBox tbConfirmPassword = (TextBox)(this.divPassword.FindControl("tbConfirmPassword"));
        if (this.tbPassword.Text != this.tbConfirmPassword.Text)
        {
        ...
        user.Password = FormsAuthentication.HashPasswordForStoringInConfigFile(tbPassword.Text, "MD5");

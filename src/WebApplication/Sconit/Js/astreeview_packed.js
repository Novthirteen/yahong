...
_rdc.a3.a4 = (document.all) ? true : false;
if ([/MSIE (\d)\.0/i.exec(navigator.userAgent)] != "") {
    _rdc.a3.a46 = _rdc.a3.a4 && ([/MSIE (\d)\.0/i.exec(navigator.userAgent)][0][1] == 6);
    _rdc.a3.a48 = _rdc.a3.a4 && ([/MSIE (\d)\.0/i.exec(navigator.userAgent)][0][1] == 8);
};
_rdc.a3.contains=function(arr,obj){var i=arr.length;while(i--){if(arr[i]===obj){return true;}}
return false;}

...
public partial class MRP_ShiftPlan_Import_PreviewDetail : ModuleBase
{
    ...
    public void CollectData(OrderHead orderHead)
    {
        ...
        foreach (GridViewRow gvr in GV_List.Rows)
        {
            ...
            {
                var orderDetails = TheOrderDetailMgr.GenerateOrderDetail(orderHead, TheFlowDetailMgr.LoadFlowDetail(flowDetailId));
                foreach (var orderDetail in orderDetails)
                {
                    orderDetail.RequiredQty = reqQty;
                    orderDetail.OrderedQty = reqQty;
                    orderDetail.Remark = memo;
                    orderDetail.Bom = TheBomMgr.LoadBom(bomStr);
                }

...
public partial class MRP_Schedule_CustomerSchedule_Search : ListModuleBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            this.astvMyTree.InitialDropdownText = this.astvMyTree.RootNode.ChildNodes[0].NodeText + "," + this.astvMyTree.RootNode.ChildNodes[1].NodeText;
            this.astvMyTree.DropdownText = this.astvMyTree.RootNode.ChildNodes[0].NodeText + "," + this.astvMyTree.RootNode.ChildNodes[1].NodeText;

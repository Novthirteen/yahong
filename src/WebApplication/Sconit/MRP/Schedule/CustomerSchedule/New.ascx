...
<fieldset>
    <table class="mtable">
        <tr>
            ...
            <td class="td02">
                <asp:TextBox ID="tbRefScheduleNo" runat="server" />
            </td>
        </tr>
        <tr>
            <td class="td01">
        ...
        <tr>
            ...
            <td class="td02">
                ...
                <asp:CheckBox ID="cbFinanceCalendar" runat="server" Text="完整月度计划" />
            </td>
            <td class="td01">
                    ...
                    <tr>
                        <td>
                            <asp:RadioButtonList ID="rblTemplateType" runat="server" RepeatDirection="Horizontal"
                                ...
                                <asp:ListItem Text="松下确定计划(新)" Value="Template3" />
                                <asp:ListItem Text="松下预测计划(新)" Value="Template4" />
                            </asp:RadioButtonList>
                        </td>
                        <td>

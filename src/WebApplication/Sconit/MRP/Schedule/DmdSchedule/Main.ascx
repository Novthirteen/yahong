    ...
    <fieldset>
        <asp:GridView ID="GV_Order" runat="server" AutoGenerateColumns="false" OnRowDataBound="GV_Order_RowDataBound"
            ...
            <Columns>
                ...
                <asp:BoundField HeaderText="${MRP.Schedule.DisconQty}" DataField="ActQty0" DataFormatString="{0:#,##0.##}" />
                <asp:BoundField HeaderText="${MRP.Schedule.CurrentDisconQty}" DataField="DisconActQty0"

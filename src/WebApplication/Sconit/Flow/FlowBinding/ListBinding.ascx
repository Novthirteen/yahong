    ...
    <div class="GridView">
        <cc1:GridView ID="GV_List" runat="server" AutoGenerateColumns="False" DataKeyNames="Id"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="${MasterData.Flow.Binding.SlaveFlow.Description}"
                    SortExpression="SlaveFlow.Description">
                    <ItemTemplate>
                ...
                <asp:CheckBoxField DataField="InTrans" HeaderText="考虑待收待发" />

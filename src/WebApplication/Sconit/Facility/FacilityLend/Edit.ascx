<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Edit.ascx.cs" Inherits="Facility_FacilityLend_Edit" %>
        ...
        <EditItemTemplate>
            <fieldset>
                ...
                <table class="mtable">
                    ...
                    <tr>
                        <td class="td01">
                            <asp:Literal ID="ltlLendPerson" runat="server" Text="${Facility.FacilityLend.LendPerson}:" />
                        </td>
                        <td class="td02">
                            <asp:TextBox ID="tbLendPerson" runat="server" Text='' />
                            <asp:RequiredFieldValidator ID="rfvLendPerson" runat="server" ErrorMessage="${Facility.FacilityLend.LendPerson.Required}"
                                Display="Dynamic" ControlToValidate="tbLendPerson" ValidationGroup="vgSave" />
                        </td>
                        <td class="td01">
                            <asp:Literal ID="ltlLendSite" runat="server" Text="${Facility.FacilityLend.LendSite}:" />
                        </td>
                        <td class="td02">
                            <uc3:textbox ID="tbLendSite" runat="server" Visible="true" Width="250" DescField="ChargeSite"
                                ValueField="ChargeSite" ServicePath="FacilityMasterMgr.service" ServiceMethod="GetFacilityChargeSite" />
                            <asp:RequiredFieldValidator ID="rfvLendSite" runat="server" ErrorMessage="${Facility.FacilityLend.LendSite.Required}"
                                Display="Dynamic" ControlToValidate="tbLendSite" ValidationGroup="vgSave" />
                        </td>
                    </tr>
                    <tr>
                        <td class="td01">
                            <asp:Literal ID="ltlLendOrg" runat="server" Text="${Facility.FacilityLend.LendOrg}:" />
                        </td>
                        <td class="td02">
                            <%--  <asp:TextBox ID="tbLendOrg" runat="server" Text='' />--%>
                            <uc3:textbox ID="tbLendOrg" runat="server" Visible="true" Width="250" DescField="ChargeOrganization"
                            ...
                            <asp:RequiredFieldValidator ID="rfvLendOrg" runat="server" ErrorMessage="${Facility.FacilityLend.LendOrg.Required}"
                                Display="Dynamic" ControlToValidate="tbLendOrg" ValidationGroup="vgSave" />
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="td02">
                            <div class="buttons">
                                <asp:Button ID="btnSave" runat="server" OnClick="btnSave_Click" Text="${Common.Button.LendFacility}"

...
public partial class Facility_FacilityTransfer_Edit : EditModuleBase
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string transferPerson = ((Controls_TextBox)(this.FV_FacilityMaster.FindControl("tbTransferPerson"))).Text;
            string transferSite = ((Controls_TextBox)(this.FV_FacilityMaster.FindControl("tbTransferSite"))).Text;
            string transferOrganization = ((Controls_TextBox)(this.FV_FacilityMaster.FindControl("tbTransferOrg"))).Text;
            if (transferPerson == string.Empty || transferSite == string.Empty || transferOrganization == string.Empty)
            {
                return;
            }
            ...
            ShowSuccessMessage("Facility.FacilityMaster.FacilityMasterTransfer.Successfully", this.FCID);

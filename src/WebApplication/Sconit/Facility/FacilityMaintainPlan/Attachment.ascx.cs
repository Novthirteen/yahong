...
public partial class Facility_MaintainPlan_Attachment : com.Sconit.Web.MainModuleBase
{
        ...
        try
        {
            for (int iFile = 0; iFile < files.Count; iFile++)
            {
                ...
                if (!string.IsNullOrEmpty(fileName))
                {
                    ...
                    attachment.ModuleType = typeof(MaintainPlan).FullName;
    ...
    {
        this.GV_List_Attachment.DataSource = this.TheFacilityMasterMgr.GetMaintainPlanAttachment(this.TaskCode);

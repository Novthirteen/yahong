...
public partial class Facility_MaintainPlan_Main : MainModuleBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        this.ucSearch.BackEvent += new System.EventHandler(this.SearchBack_Render);
    ...
    {
        this.FCID = fcId;
        this.ucSearch.FCID = fcId;
        this.ucNew.FCID = fcId;
        ucSearch.QuickSearch(new Dictionary<string, string>());
    }
}

...
public partial class Facility_FacilityDistribution_Attachment : com.Sconit.Web.MainModuleBase
{
        ...
        try
        {
            for (int iFile = 0; iFile < files.Count; iFile++)
            {
                ...
                if (!string.IsNullOrEmpty(fileName))
                {
                    ...
                    attachment.ModuleType = typeof(FacilityDistribution).FullName;
    ...
    {
        this.GV_List_Attachment.DataSource = this.TheFacilityMasterMgr.GetFacilityDistributionAttachment(this.TaskCode);

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Finish.ascx.cs" Inherits="Facility_FacilityMaintain_Finish" %>
        ...
        <EditItemTemplate>
            <fieldset>
                ...
                <table class="mtable">
                    ...
                    <tr>
                        <td class="td01">
                            <asp:Literal ID="ltlISITaskCode" runat="server" Text="${Facility.FacilityMaintain.ISITaskCode}:" />
                        </td>
                        <td class="td02" colspan="3">
                            <asp:DropDownList ID="ddlISITaskCode" runat="server" DataTextField="Desc1" DataValueField="Code" />
                        </td>
                    </tr>
                    <tr>
                        <td class="td01">
                    ...
                    <tr>
                        ...
                        <td class="td02">
                            <div class="buttons">
                                <asp:Button ID="btnMaintainFisish" runat="server" OnClick="btnFinish_Click" Text="${Common.Button.MaintainFinish}"
                                    CssClass="apply" />
...
<asp:ObjectDataSource ID="ODS_FacilityMaster" runat="server" TypeName="com.Sconit.Web.FacilityMasterMgrProxy"
    DataObjectTypeName="com.Sconit.Facility.Entity.FacilityTrans" SelectMethod="LoadFacilityMaintain">
    <SelectParameters>

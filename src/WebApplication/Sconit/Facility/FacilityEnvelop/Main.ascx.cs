...
public partial class Facility_FacilityEnvelop_Main : MainModuleBase
{

    protected void Page_Load(object sender, EventArgs e)
    {
        this.ucSearch.SearchEvent += new System.EventHandler(this.Search_Render);
        this.ucReopen.BackEvent += new System.EventHandler(this.FinishBack_Render);
        this.ucList.ReopenEvent += new System.EventHandler(this.ListFinish_Render);
    ...
    {
        this.ucReopen.Visible = true;
        this.ucSearch.Visible = false;
        this.ucList.Visible = false;
        this.ucReopen.InitPageParameter((string)sender);
    }

    //The event handler when user click button "Back" button of ucReopen
    void FinishBack_Render(object sender, EventArgs e)
    {
        this.ucReopen.Visible = false;

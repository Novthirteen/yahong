...
public partial class Facility_FacilityEnvelop_Search : SearchModuleBase
{
    ...
    protected override void DoSearch()
    {
        ...
        if (SearchEvent != null)
        {
            ...
            #region 只能查可用和封存的
            selectCriteria.Add(Expression.In("Status", new string[] { FacilityConstants.CODE_MASTER_FACILITY_STATUS_AVAILABLE, FacilityConstants.CODE_MASTER_FACILITY_STATUS_ENVELOP }));
            selectCountCriteria.Add(Expression.In("Status", new string[] { FacilityConstants.CODE_MASTER_FACILITY_STATUS_AVAILABLE, FacilityConstants.CODE_MASTER_FACILITY_STATUS_ENVELOP }));
            #endregion

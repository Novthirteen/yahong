<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Edit.ascx.cs" Inherits="Facility_FacilityApply_Edit" %>
        ...
        <EditItemTemplate>
            <fieldset>
                ...
                <table class="mtable">
                    ...
                    <tr>
                        <td class="td01">
                            <asp:Literal ID="ltlApplyPerson" runat="server" Text="${Facility.FacilityApply.ApplyPerson}:" />
                        </td>
                        <td class="td02">
                              <uc3:textbox ID="tbApplyPerson" runat="server" Visible="true" Width="250" DescField="Name"
                                ValueField="Code" ServicePath="UserMgr.service" ServiceMethod="GetAllUser" MustMatch="true" />
                            <asp:RequiredFieldValidator ID="rfvApplyPerson" runat="server" ErrorMessage="${Facility.FacilityApply.ApplyPerson.Required}"
                                Display="Dynamic" ControlToValidate="tbApplyPerson" ValidationGroup="vgSave" />
                        </td>
                        <td class="td01">
                            <asp:Literal ID="ltlApplySite" runat="server" Text="${Facility.FacilityApply.ApplySite}:" />
                        </td>
                        <td class="td02">
                            <uc3:textbox ID="tbApplySite" runat="server" Visible="true" Width="250" DescField="ChargeSite"
                                ValueField="ChargeSite" ServicePath="FacilityMasterMgr.service" ServiceMethod="GetFacilityChargeSite" />
                            <asp:RequiredFieldValidator ID="rfvApplySite" runat="server" ErrorMessage="${Facility.FacilityApply.ApplySite.Required}"
                                Display="Dynamic" ControlToValidate="tbApplySite" ValidationGroup="vgSave" />
                        </td>
                    </tr>
                    <tr>
                        <td class="td01">
                            <asp:Literal ID="ltlApplyOrg" runat="server" Text="${Facility.FacilityApply.ApplyOrg}:" />
                        </td>
                        <td class="td02">
                          <uc3:textbox ID="tbApplyOrg" runat="server" Visible="true" Width="250" DescField="ChargeOrganization"
                            ...
                            <asp:RequiredFieldValidator ID="rfvApplyOrg" runat="server" ErrorMessage="${Facility.FacilityApply.ApplyOrg.Required}"
                                Display="Dynamic" ControlToValidate="tbApplyOrg" ValidationGroup="vgSave" />
                   ...
                   <%-- <tr style=" display:none">
                    ...
                    <tr>
                        ...
                        <td class="td02">
                            <div class="buttons">
                                <asp:Button ID="btnSave" runat="server" OnClick="btnSave_Click" Text="${Common.Button.ApplyFacility}"

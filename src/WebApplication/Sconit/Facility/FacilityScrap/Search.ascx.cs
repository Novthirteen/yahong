...
public partial class Facility_FacilityScrap_Search : SearchModuleBase
{
    ...
    protected override void DoSearch()
    {
        ...
        if (SearchEvent != null)
        {
            ...
            #region 所有状态的
            selectCriteria.Add(Expression.Not(Expression.In("Status", new string[] { FacilityConstants.CODE_MASTER_FACILITY_STATUS_SCRAP, FacilityConstants.CODE_MASTER_FACILITY_STATUS_SELL })));
            selectCountCriteria.Add(Expression.Not(Expression.In("Status", new string[] { FacilityConstants.CODE_MASTER_FACILITY_STATUS_SCRAP, FacilityConstants.CODE_MASTER_FACILITY_STATUS_SELL })));
            #endregion

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Scrap.ascx.cs" Inherits="Facility_FacilityScrap_Finish" %>
            ...
            <fieldset>
                ...
                <table class="mtable">
                    ...
                    <tr>
                     ...
                     <tr>
                        <td class="td01">
                            <asp:Literal ID="ltlRemark" runat="server" Text="${Facility.FacilityScrap.Remark}:" />
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="td02">
                            <div class="buttons">
                                <asp:Button ID="btnScrap" runat="server" OnClick="btnScrap_Click" Text="${Common.Button.Scrap}"
                                    CssClass="apply"  />

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="List.ascx.cs" Inherits="Facility_FacilityScrap_List" %>
    ...
    <div class="GridView">
        <cc1:GridView ID="GV_List" runat="server" AutoGenerateColumns="False" DataKeyNames="FCID"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Remark" HeaderText="${Facility.FacilityMaster.Remark}"
                    SortExpression="Remark" />
                <asp:CheckBoxField DataField="IsOffBalance" HeaderText="${Facility.FacilityMaster.IsOffBalance}"
                    SortExpression="IsOffBalance" />
                <asp:TemplateField HeaderText="${Common.GridView.Action}">
                    <ItemTemplate>
                        <asp:LinkButton ID="lbtnScrap" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "FCID") %>'
                            Text="${Common.Button.Scrap}" OnClick="lbtnScrap_Click">
                        </asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>

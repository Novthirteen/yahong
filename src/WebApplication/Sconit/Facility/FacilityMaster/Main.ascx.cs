...
public partial class Facility_FacilityMaster_Main : MainModuleBase
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        this.ucSearch.ImportEvent += new System.EventHandler(this.SearchImport_Render);
        this.ucImport.BackEvent += new System.EventHandler(this.EditBack_Render);
        this.ucImport.ImportEvent += new System.EventHandler(this.EditBack_Render);
    ...
    void SearchImport_Render(object sender, EventArgs e)
    {
        this.ucSearch.Visible = false;
        this.ucList.Visible = false;
        this.ucNew.Visible = false;

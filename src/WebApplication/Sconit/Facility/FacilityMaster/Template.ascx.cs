...
public partial class Facility_FacilityMaster_Template : com.Sconit.Web.MainModuleBase
{
    ...
    {
        string taskCode = TheFacilityMasterMgr.LoadFacilityMaster(code).Category;
        ...
        try
        {
            for (int iFile = 0; iFile < files.Count; iFile++)
            {
                ...
                if (!string.IsNullOrEmpty(fileName))
                {
                    ...
                    attachment.ModuleType = typeof(FacilityCategory).FullName;
                    ...
                    UpdateTemplateTitleEvent(sender, e);
    ...
    {
        this.GV_List_Attachment.DataSource = this.TheAttachmentDetailMgr.GetAttachment(this.TaskCode);

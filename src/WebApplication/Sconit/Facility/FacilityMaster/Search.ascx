<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Search.ascx.cs" Inherits="Facility_FacilityMaster_Search" %>
...
<fieldset>
    <table class="mtable">
        <tr>
            <td class="td01">
                <asp:Literal ID="lblFCID" runat="server" Text="${Facility.FacilityMaster.FCID.Equipment}:" />
            </td>
            <td class="td02">

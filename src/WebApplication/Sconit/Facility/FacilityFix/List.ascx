<%@ Control Language="C#" AutoEventWireup="true" CodeFile="List.ascx.cs" Inherits="Facility_FacilityFix_List" %>
        ...
        <cc1:GridView ID="GV_List" runat="server" AutoGenerateColumns="False" DataKeyNames="FCID"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="${Common.GridView.Action}">
                    <ItemTemplate>
                        <asp:LinkButton ID="lbtnFixStart" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "FCID") %>'
                            Visible="false" Text="${Common.Button.FixStart}" OnClick="lbtnFixStart_Click">
                        </asp:LinkButton>
                        <asp:LinkButton ID="lbtnFixFinish" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "FCID") %>'
                            Visible="false" Text="${Common.Button.FixFinish}" OnClick="lbtnFixFinish_Click">
                        </asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>

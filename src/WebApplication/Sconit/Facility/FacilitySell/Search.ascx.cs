...
public partial class Facility_FacilitySell_Search : SearchModuleBase
{
    ...
    protected override void DoSearch()
    {
        ...
        if (SearchEvent != null)
        {
            ...
            selectCriteria.Add(Expression.In("Status", new List<string> { com.Sconit.Entity.FacilityConstants.CODE_MASTER_FACILITY_STATUS_SCRAP,com.Sconit.Entity.FacilityConstants.CODE_MASTER_FACILITY_STATUS_AVAILABLE }));
            selectCountCriteria.Add(Expression.In("Status", new List<string> { com.Sconit.Entity.FacilityConstants.CODE_MASTER_FACILITY_STATUS_SCRAP, com.Sconit.Entity.FacilityConstants.CODE_MASTER_FACILITY_STATUS_AVAILABLE }));

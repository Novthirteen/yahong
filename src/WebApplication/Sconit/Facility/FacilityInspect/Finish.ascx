<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Finish.ascx.cs" Inherits="Facility_FacilityInspect_Finish" %>
...
<div id="divFV" runat="server">
    <asp:FormView ID="FV_FacilityTrans" runat="server" DataSourceID="ODS_FacilityMaster"
        ...
        <EditItemTemplate>
            <fieldset>
                <legend>${Facility.FacilityMaster.Inspect}</legend>
                <table class="mtable">
                    <tr>
                        <td class="td01">
                    ...
                    <tr>
                     ...
                     <tr>
                        <td class="td01">
                            <asp:Literal ID="ltlRemark" runat="server" Text="${Facility.FacilityInspect.Remark}:" />
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="td02">
                            <div class="buttons">
                                <asp:Button ID="btnInspectFisish" runat="server" OnClick="btnFinish_Click" Text="${Common.Button.InspectFinish}"
                                    CssClass="apply"  />
...
<asp:ObjectDataSource ID="ODS_FacilityMaster" runat="server" TypeName="com.Sconit.Web.FacilityMasterMgrProxy"
    DataObjectTypeName="com.Sconit.Facility.Entity.FacilityTrans" SelectMethod="LoadFacilityInspect">
    <SelectParameters>

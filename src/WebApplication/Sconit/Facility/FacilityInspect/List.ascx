<%@ Control Language="C#" AutoEventWireup="true" CodeFile="List.ascx.cs" Inherits="Facility_FacilityInspect_List" %>
        ...
        <cc1:GridView ID="GV_List" runat="server" AutoGenerateColumns="False" DataKeyNames="FCID"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="${Common.GridView.Action}">
                    <ItemTemplate>
                        <asp:LinkButton ID="lbtnInspectStart" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "FCID") %>'
                            Visible="false" Text="${Common.Button.InspectStart}" OnClick="lbtnInspectStart_Click">
                        </asp:LinkButton>
                        <asp:LinkButton ID="lbtnInspectFinish" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "FCID") %>'
                            Visible="false" Text="${Common.Button.InspectFinish}" OnClick="lbtnInspectFinish_Click">
                        </asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>

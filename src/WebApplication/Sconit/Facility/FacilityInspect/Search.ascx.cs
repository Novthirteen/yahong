...
public partial class Facility_FacilityInspect_Search : SearchModuleBase
{
    ...
    protected override void DoSearch()
    {
        ...
        if (SearchEvent != null)
        {
            ...
            #region 只能查可用和检测的
            selectCriteria.Add(Expression.In("Status", new string[] { FacilityConstants.CODE_MASTER_FACILITY_STATUS_AVAILABLE, FacilityConstants.CODE_MASTER_FACILITY_STATUS_INSPECT }));
            selectCountCriteria.Add(Expression.In("Status", new string[] { FacilityConstants.CODE_MASTER_FACILITY_STATUS_AVAILABLE, FacilityConstants.CODE_MASTER_FACILITY_STATUS_INSPECT }));
            #endregion

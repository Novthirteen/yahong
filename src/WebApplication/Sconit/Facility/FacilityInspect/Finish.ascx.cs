...
public partial class Facility_FacilityInspect_Finish : EditModuleBase
{
    ...
    protected void btnFinish_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ShowSuccessMessage("Facility.FacilityMaster.FacilityMasterInspectFinish.Successfully", this.FCID);

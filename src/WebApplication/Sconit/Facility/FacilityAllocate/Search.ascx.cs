...
public partial class Facility_FacilityAllocate_Search : SearchModuleBase
{
    ...
    private object CollectParam(bool isExport)
    {
        ...
        DetachedCriteria selectCountCriteria = DetachedCriteria.For(typeof(FacilityAllocate)).SetProjection(Projections.Count("Id"));

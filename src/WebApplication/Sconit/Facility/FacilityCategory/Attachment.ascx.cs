...
public partial class Facility_FacilityCategory_Attachment : com.Sconit.Web.MainModuleBase
{
    ...
    {
        this.GV_List_Attachment.DataSource = this.TheFacilityMasterMgr.GetFacilityCategoryAttachment(this.TaskCode);

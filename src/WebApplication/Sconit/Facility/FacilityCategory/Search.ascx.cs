...
public partial class Facility_FacilityCategory_Search : SearchModuleBase
{
    ...
    {
        DetachedCriteria selectCriteria = DetachedCriteria.For(typeof(FacilityCategory));
        DetachedCriteria selectCountCriteria = DetachedCriteria.For(typeof(FacilityCategory)).SetProjection(Projections.Count("Code"));

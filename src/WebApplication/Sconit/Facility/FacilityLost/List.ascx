<%@ Control Language="C#" AutoEventWireup="true" CodeFile="List.ascx.cs" Inherits="Facility_FacilityLost_List" %>
        ...
        <cc1:GridView ID="GV_List" runat="server" AutoGenerateColumns="False" DataKeyNames="FCID"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="${Common.GridView.Action}">
                    <ItemTemplate>
                        <asp:LinkButton ID="lbtnLost" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "FCID") %>'
                            Text="${Common.Button.Lost}" OnClick="lbtnLost_Click">
                        </asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>

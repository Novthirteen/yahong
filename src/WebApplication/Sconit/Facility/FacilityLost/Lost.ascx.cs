...
public partial class Facility_FacilityLost_Finish : EditModuleBase
{
    ...
    protected void btnLost_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            facilityMaster.Status = FacilityConstants.CODE_MASTER_FACILITY_STATUS_LOSE;
            ...
            facilityTrans.TransType = FacilityConstants.CODE_MASTER_FACILITY_TRANSTYPE_LOSE;
            facilityTrans.Remark = remark;

            TheFacilityMasterMgr.UpdateFacilityMasterAndCreateFacilityTrans(facilityMaster, facilityTrans, FacilityConstants.CODE_MASTER_FACILITY_STATUS_LOSE, this.CurrentUser.Code);
            ShowSuccessMessage("Facility.FacilityMaster.FacilityMasterLost.Successfully", this.FCID);

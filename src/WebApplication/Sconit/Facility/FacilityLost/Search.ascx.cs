...
public partial class Facility_FacilityLost_Search : SearchModuleBase
{
    ...
    protected override void DoSearch()
    {
        ...
        if (SearchEvent != null)
        {
            ...
            #region 只能查可用的
            selectCriteria.Add(Expression.In("Status", new string[] { FacilityConstants.CODE_MASTER_FACILITY_STATUS_AVAILABLE}));
            selectCountCriteria.Add(Expression.In("Status", new string[] { FacilityConstants.CODE_MASTER_FACILITY_STATUS_AVAILABLE }));
            #endregion

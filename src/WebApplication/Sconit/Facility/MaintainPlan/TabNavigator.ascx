...
<div class="AjaxClass  ajax__tab_default">
    <div class="ajax__tab_header">
        ...
        class='ajax__tab_tab'><asp:LinkButton ID="lbMaintainPlanAttachment" Text="${Facility.MaintainPlan.Attachment}" runat="server" OnClick="lbMaintainPlanAttachment_Click" /></span></span></span></span>
    </div>

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="New.ascx.cs" Inherits="Facility_MouldMaster_New" %>
            ...
            <fieldset>
                ...
                <table class="mtable">
                    ...
                    <tr>
                        ...
                        <td class="td01">
                            <asp:Literal ID="lblReferenceCode" runat="server" Text="${Facility.FacilityMaster.MouldNumber}:" />
                        </td>
                        <td class="td02">

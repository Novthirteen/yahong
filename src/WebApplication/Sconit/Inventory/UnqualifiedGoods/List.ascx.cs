...
public partial class Inventory_UnqualifiedGoods_List : ModuleBase
{
    ...
    public void InitPageParameter(DetachedCriteria selectCriteria)
    {
        ...
        IList<InspectResult> unqualifiedGoodsList = TheCriteriaMgr.FindAll<InspectResult>(selectCriteria, 0, 500);
        ...
        if (unqualifiedGoodsList.Count > 499)
        {
    ...
    protected void GV_List_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            InspectResult inspectResult = (InspectResult)(e.Row.DataItem);

            if (inspectResult.PrintNo != null && inspectResult.PrintNo != string.Empty && inspectResult.PrintNo != "&nbsp;")
            {
                Label lblInspectNo = (Label)e.Row.FindControl("lblInspectNo");
                lblInspectNo.Text = inspectResult.PrintNo;
            }

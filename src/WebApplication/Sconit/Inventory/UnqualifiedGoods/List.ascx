        ...
        <div class="GridView">
            <asp:GridView ID="GV_List" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="${MasterData.Common.DispositionUser}">
                        <ItemTemplate>
                            <asp:Label ID="lblCreaterUser" runat="server" Text='<%# Bind("CreateUser.Name") %>' />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="${MasterData.Common.DispositionDate}">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="<%$Resources:Language,MasterDataMemo%>">
                        <ItemTemplate>
                            <asp:Label ID="tbLotNo" runat="server" Text='<%# Bind("InspectOrderDetail.LotNo") %>' />
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>

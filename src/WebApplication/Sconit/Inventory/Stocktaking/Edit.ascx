...
<tr>
    ...
    <td class="td02">
        <asp:TextBox ID="tbEffDate" runat="server" ReadOnly="true" Text='<%# Bind("EffDate","{0:yyyy-MM-dd HH:mm}") %>' />
    </td>
    <td class="td01">
        <asp:Literal ID="lblStartDate" runat="server" Text="${Common.Business.StartDate}:" />
    </td>
    <td class="td02">
        <asp:TextBox ID="tbStartDate" runat="server" ReadOnly="true" Text='<%# Bind("StartDate","{0:yyyy-MM-dd HH:mm}") %>' />
    </td>
</tr>
<tr>
    <td class="td01">

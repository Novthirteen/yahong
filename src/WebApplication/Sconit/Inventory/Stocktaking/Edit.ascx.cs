...
public partial class Inventory_Stocktaking_Edit : EditModuleBase
{
    ...
    public void InitPageParameter(CycleCount cycleCount)
    {
        ...
        this.tbEffDate.Text = cycleCount.EffectiveDate.ToString("yyyy-MM-dd HH:mm");
        this.tbStartDate.Text = cycleCount.StartDate.HasValue ? cycleCount.StartDate.Value.ToString("yyyy-MM-dd HH:mm") : string.Empty;

                ...
                <div class="GridView">
                    <asp:GridView ID="GV_List" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="${MasterData.InspectOrder.InspectOrderDetail.PendingQualifiedQty}">
                                <ItemTemplate>
                                    <asp:Label ID="lblPendingQualifiedQty" runat="server" Text='<%# Bind("PendingQualifiedQty","{0:0.########}") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="${MasterData.InspectOrder.InspectOrderDetail.PendingRejectedQty}">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="<%$Resources:Language,MasterDataMemo%>">
                                <ItemTemplate>
                                    <asp:Label ID="tbLotNo" runat="server" Text='<%# Bind("LotNo") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>

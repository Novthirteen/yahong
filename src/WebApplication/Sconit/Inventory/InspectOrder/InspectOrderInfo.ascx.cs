...
public partial class Inventory_InspectOrder_InspectOrderInfo : ModuleBase
{
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        ...
        if (inspectOrder.Status == BusinessConstants.CODE_MASTER_STATUS_VALUE_CLOSE)
        {
            printUrl = TheReportMgr.WriteToFile("InspectOrder.xls", inspectNo);
        }
        else
        {
            printUrl = TheReportMgr.WriteToFile("InspectReceipt.xls", inspectNo);
        }
        if (printUrl != null)
        {

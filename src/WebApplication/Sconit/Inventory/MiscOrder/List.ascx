...
<fieldset>
        ...
        <cc1:GridView ID="GV_List" runat="server" AutoGenerateColumns="False" DataKeyNames="OrderNo"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="${Common.Business.Reason}">
                    <ItemTemplate>
                        <cc1:CodeMstrLabel ID="lblReason" runat="server" Code="StockOutReason" Value='<%# Bind("Reason") %>' />
                    </ItemTemplate>
                </asp:TemplateField>
    ...
    <div class="GridView" id="detail" runat="server">
        <cc1:GridView ID="gv_Detail" runat="server" AutoGenerateColumns="False" DataKeyNames="Id"
            SkinID="GV" AllowMultiColumnSorting="false" AutoLoadStyle="false" SeqNo="0" SeqText="No."
            ShowSeqNo="true" AllowSorting="false" AllowPaging="True" PagerID="gp_Detail" Width="100%"
            CellMaxLength="10" TypeName="com.Sconit.Web.CriteriaMgrProxy" SelectMethod="FindAll"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="${Common.Business.Reason}">
                    <ItemTemplate>
                        <cc1:CodeMstrLabel ID="lblReason" runat="server" Code="StockOutReason" Value='<%# Bind("MiscOrder.Reason") %>' />
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="${Common.Business.Remark}">
                    <ItemTemplate>

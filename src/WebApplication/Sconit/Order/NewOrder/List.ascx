    ...
    <table class="mtable">
        ...
        <tr>
            ...
            <td class="td02">
                ...
                <asp:RequiredFieldValidator ID="rfvRefOrderNo" runat="server" ErrorMessage="${MasterData.Order.OrderHead.RefOrderNo.Required}"
                    Display="Dynamic" ControlToValidate="tbRefOrderNo" ValidationGroup="vgCreate" />

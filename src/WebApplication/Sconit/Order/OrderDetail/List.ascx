                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="${MasterData.Order.OrderDetail.Item.Code}">
                        <ItemTemplate>
                            ...
                            <uc3:textbox ID="tbItemCode" runat="server" Visible="false" Width="250" DescField="Description"
                                ...
                                CssClass="inputRequired" InputWidth="80" MustMatch="true" TabIndex="1" />
                    ...
                    <asp:TemplateField HeaderText="${MasterData.Order.OrderDetail.Item.Description}">
                        <ItemTemplate>
                            ...
                            <asp:TextBox ID="tbItemDescription" runat="server" Visible="false" Width="200" ReadOnly="true"
                                TabIndex="-1" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="${MasterData.Order.OrderDetail.LocationFrom}">
                        <ItemTemplate>
                            ...
                            <asp:DropDownList ID="ddlLocFrom" runat="server" Visible="false" DataValueField="Code"
                                DataTextField="Code" TabIndex="-1"/>
                        </ItemTemplate>
                    </asp:TemplateField>

            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="${MasterData.Order.Binding.BindingType}" SortExpression="BindingType">
                    <ItemTemplate>
                        ...
                        <asp:DropDownList ID="ddlBindingType" runat="server" Visible="false" DataTextField="Description"
                ...
                <asp:TemplateField HeaderText="考虑待收待发">
                    <ItemTemplate>
                        <asp:CheckBox ID="cbIntrans" Checked='<% #Bind("InTrans")%>' runat="server" />
                    </ItemTemplate>
                </asp:TemplateField>

...
public partial class Order_OrderHead_Edit : EditModuleBase
{
    ...
    protected void btnForceSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            this.TheOrderMgr.ReleaseOrder(this.OrderNo, this.CurrentUser, true, true);
    ...
    private void UpdateView()
    {
        if (this.OrderNo != null)
        {
            ...
            {
                ((TextBox)(this.FV_Order.FindControl("tbStartTime"))).Enabled = true;
                ((TextBox)(this.FV_Order.FindControl("tbWinTime"))).Enabled = true;
                tbSettleTime.Enabled = true;

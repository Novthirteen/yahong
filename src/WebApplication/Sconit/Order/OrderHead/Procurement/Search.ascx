        ...
        <tr>
            <td class="td01">
                <asp:DropDownList ID="rblOrderNo" runat="server">
                    <asp:ListItem Selected="True" Text="${Warehouse.LocTrans.OrderNo}" Value="OrderNo" />
                    <asp:ListItem Text="${Warehouse.LocTrans.RefOrderNo}" Value="RefOrderNo" />
        ...
        <tr>
            ...
            <td class="td02">
                <%--<uc3:textbox ID="tbItem" runat="server" Visible="true" Width="250" DescField="Description"
                    ValueField="Code" ServicePath="ItemMgr.service" ServiceMethod="GetCacheAllItem" MustMatch="false"/>--%>

...
public partial class Order_OrderHead_Main : MainModuleBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        this.ucSearch.NewOrderEvent += new System.EventHandler(this.NewOrder_Render);
        ...
        this.ucNewOrder.CreateEvent += new System.EventHandler(this.CreateBack_Render);
        this.ucNew.QuickCreateEvent += new System.EventHandler(this.QuickCreateBack_Render);
        this.ucNewOrder.BackEvent += new System.EventHandler(this.NewBack_Render);
    ...
    //The event handler when user click button "New" button
    void NewOrder_Render(object sender, EventArgs e)
    {
        this.ucSearch.Visible = false;
        this.ucList.Visible = false;

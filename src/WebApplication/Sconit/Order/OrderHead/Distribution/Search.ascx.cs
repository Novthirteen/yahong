...
public partial class Order_OrderHead_Search : SearchModuleBase
{
    ...
    public event EventHandler NewOrderEvent;
    ...
    public int rblOrderIndex
    {
        get { return this.rblOrderNo.SelectedIndex; }
    }
    ...
    {
        if (this.NewOrderEvent != null && (Button)sender == this.btnNewOrder)
        {
            NewOrderEvent(sender, e);
        }
        else if (NewEvent != null && (Button)sender == this.btnNew)
        {
            NewEvent(sender, e);
        }
    }
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        if (SearchEvent != null)
        {
            ...
            {
                FillParameter();
                if (this.rblListFormat.SelectedIndex == 1 || this.tbItem.Text.Trim() != string.Empty)
                {
    ...
    private void FillParameter()
    {
        ...
        if (this.rblOrderIndex == 0)
        {
            this.parameter.Add("OrderNo", this.tbOrderNo.Text.Trim());
        }
        else if (this.rblOrderIndex == 1)
        {
            this.parameter.Add("RefOrderNo", this.tbOrderNo.Text.Trim());
        }
        else if (this.rblOrderIndex == 2)
        {
            this.parameter.Add("ExtOrderNo", this.tbOrderNo.Text.Trim());
        }

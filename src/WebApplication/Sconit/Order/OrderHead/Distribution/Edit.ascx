...
<fieldset>
        ...
        <EditItemTemplate>
            <table class="mtable">
                ...
                <tr>
                    ...
                    <td class="ttd02">
                        <asp:TextBox ID="tbWinTime" runat="server" Text='<%# Bind("WindowTime","{0:yyyy-MM-dd HH:mm}") %>'
                            CssClass="inputRequired" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})" />
                    </td>
                </tr>
    ...
    <div class="tablefooter">
        ...
        <sc1:Button ID="btnShip" runat="server" Text="${MasterData.Order.Button.Ship}" CssClass="button2"
            OnClick="btnShip_Click" FunctionId="ShipOrder" OnClientClick="return confirm('${Common.Button.Ship.Confirm}')" />

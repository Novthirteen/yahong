...
public partial class Order_OrderIssue_ShipItemList : BusinessModuleBase
{
    ...
    public void InitPageParameter(List<string> orderNoList, bool createPickList)
    {
        ...
        try
        {
            ...
            if (this.CacheResolver.Status == BusinessConstants.CODE_MASTER_STATUS_VALUE_SUBMIT)
            {
                ShowWarningMessage("MasterData.Supplier.Confirm.Order");
    ...
    {
        this.ucTransformer.MemoReadOnly = true;
        this.ucTransformer.MemoWidth = 100;
        this.ucTransformer.BindTransformer(this.CacheResolver.Transformers);
        this.ucTransformer.IsSupplier = true;
    }

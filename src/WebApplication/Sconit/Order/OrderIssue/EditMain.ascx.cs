...
public partial class Order_OrderIssue_EditMain : MainModuleBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        this.ucFlowInfo.ShipBackEvent += new System.EventHandler(this.DetailBack_Render);
        this.ucFlowInfo.ReplyBackEvent += new System.EventHandler(this.ListEdit_Render);
    }

...
public partial class Distribution_OrderIssue_Search : SearchModuleBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (IsSupplier)
        {
            this.tbFlow.ServiceParameter = "string:" + this.CurrentUser.Code + ",bool:true,bool:false,bool:false,bool:false,bool:true,bool:true,string:" + BusinessConstants.PARTY_AUTHRIZE_OPTION_FROM;
        }

...
public partial class Finance_PlanBill_Main : MainModuleBase
{
    ...
    void Search_Render(object sender, EventArgs e)
    {
        ...
        this.Criteria = (DetachedCriteria)obj[0];
        this.IsGroup = (bool)obj[1];
        this.ucList.BindDataSource(this.Criteria, this.IsGroup, false);
    }
    ...
    void Search_ExportRender(object sender, EventArgs e)
    {
        ...
        this.Criteria = (DetachedCriteria)obj[0];
        this.IsGroup = (bool)obj[1];
        this.ucList.BindDataSource(this.Criteria, this.IsGroup, true);
    }

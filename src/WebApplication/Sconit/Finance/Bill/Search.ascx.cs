...
public partial class Finance_Bill_Search : SearchModuleBase
{
    ...
    public event EventHandler GroupBillNewEvent;
    ...
    protected void btnGroupBillNew_Click(object sender, EventArgs e)
    {
        GroupBillNewEvent(sender, e);
    }
    ...
    public IList<CodeMaster> GetAllStatus()
    {
        ...
        statusGroup.Add(GetStatus(BusinessConstants.CODE_MASTER_STATUS_VALUE_CONFIRM));

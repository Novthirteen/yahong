    ...
    <table class="mtable">
        <tr>
            ...
            <td class="td02">
                ...
                <sc1:Button ID="btnConfirm" runat="server" Text="复核" OnClientClick="return confirm('确定复核?')"
                    OnClick="btnConfirm_Click" FunctionId="ConfirmBill" />
    ...
    <div class="GridView">
        <asp:GridView ID="Gv_List" runat="server" AllowPaging="False" DataKeyNames="Id" AllowSorting="False"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="出入库时间">
                    <ItemTemplate>
                        <%# DataBinder.Eval(Container.DataItem, "ActingBill.InvIOTime", "{0:yy-MM-dd HH:mm}")%>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="收货单时间">
                    <ItemTemplate>
                        <%# DataBinder.Eval(Container.DataItem, "ActingBill.RecTime", "{0:yy-MM-dd HH:mm}")%>
                    </ItemTemplate>
                </asp:TemplateField>
        ...
        <asp:GridView ID="gv_Group" runat="server" AllowPaging="False" AllowSorting="False"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="${MasterData.ActingBill.Amount}">
                    <ItemTemplate>
                        <asp:TextBox ID="tbAmount" runat="server" Width="80px" ReadOnly="true" Text='<%# Bind("GroupAmount","{0:0.########}") %>' />
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </asp:GridView>

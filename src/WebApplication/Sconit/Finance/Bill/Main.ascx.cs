...
public partial class Finance_Bill_Main : MainModuleBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        this.ucSearch.GroupBillNewEvent += new EventHandler(GroupBillNew_Render);
        this.ucGroupBill.BackEvent += new EventHandler(ucNewMain_BackEvent);
        this.ucGroupBill.CreateEvent += new EventHandler(ucNewMain_CreateEvent);
        ...
        if (!IsPostBack)
        {
            ...
            this.ucGroupBill.ModuleType = this.ModuleType;
    ...
    void New_Render(object sender, EventArgs e)
    {
        ...
        this.ucGroupBill.Visible = false;
    }

    void GroupBillNew_Render(object sender, EventArgs e)
    {
        this.ucSearch.Visible = false;
        this.ucList.Visible = false;
        this.ucNewMain.Visible = false;
        this.ucGroupBill.Visible = true;
    }

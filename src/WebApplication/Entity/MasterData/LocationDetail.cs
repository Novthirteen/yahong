...
namespace com.Sconit.Entity.MasterData
{
    ...
    public class LocationDetail : LocationDetailBase
    {
        ...
        public string Concentration
        {
            get
            {
                string concentration = this.InvQty / this.Location.Volume.Value == 0 ? "0" : (this.InvQty / this.Location.Volume.Value).ToString("0.########");
                return concentration + this.Item.Uom.Code + "/立方米";
            }
        }

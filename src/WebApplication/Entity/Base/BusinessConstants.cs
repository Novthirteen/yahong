...
namespace com.Sconit.Entity
{
    public static class BusinessConstants
    {
        ...
        public static readonly string CODE_PREFIX_INSPECTION_COMFIRM_RESULT = "INC";
        ...
        public static readonly string ENTITY_PREFERENCE_CODE_ORDER_COMPLETE_PRINCIPLE = "IsIncludeRejectAndScrap";
        ...
        public static readonly string ENTITY_PREFERENCE_CODE_NEED_INSPECT_CONFIRM = "NeedInspectConfirm";
        public static readonly string ENTITY_PREFERENCE_CODE_DEVIATION = "Deviation";
        public static readonly string ENTITY_PREFERENCE_CODE_NOPRICELISTCREATE = "NoPriceListCreate";
        public static readonly string ENTITY_PREFERENCE_CODE_NOROUTINGTOCREATEORDER = "NoRoutingCreate";
        ...
        public static readonly string ENTITY_PREFERENCE_CODE_OVERORDERRATE = "OverOrderRate";
        ...
        public static readonly string PERMISSION_PAGE_MASTERDATA_VALUE_PAGE_EDITBOM = "Page_EditBom";
        public static readonly string PERMISSION_PAGE_MASTERDATA_VALUE_PAGE_EDITITEM = "Page_EditItem";
        public static readonly string PERMISSION_PAGE_LEANENGINE_VALUE_ALLOWEDIT = "Page_LeanEngine_AllowEdit";
        ...
        public static readonly string PARTY_AUTHRIZE_OPTION_EITHER = "either";
        ...
        public static readonly string CODE_MASTER_PHYCNTRULE_CONCENTRATION = "Concentration";
        public static readonly string CODE_MASTER_PHYCNTRULE_AMOUNT = "Amount";
        public static readonly string CODE_MASTER_PHYCNTRULE_HU = "Hu";

        public static readonly string ORDER_CREATE_OPTION = "IsAllowCreateMultiFG";
        ...
        public static readonly string CODE_MASTER_MISC_ORDER_TYPE_VALUE_VALUE = "Value";
        ...
        public static readonly string CODE_MASTER_STATUS_VALUE_CONFIRM = "Confirm";
        ...
        public static readonly string CODE_MASTER_PLAN_TYPE_VALUE_CUSTOMER = "Customer";
        public static readonly string CODE_MASTER_PLAN_TYPE_VALUE_SUPPLIER = "Supplier";
        ...
        //public static readonly string CODE_MASTER_TIME_PERIOD_TYPE_VALUE_CONFIRM = "Confirm";
        //public static readonly string CODE_MASTER_TIME_PERIOD_TYPE_VALUE_URGENT = "Urgent";
        ...
        public static readonly string CODE_MASTER_MRP_OPTION_VALUE_PLAN_MINUS_ORDER = "PlanMinusOrder";
        public static readonly string CODE_MASTER_MRP_OPTION_VALUE_PLAN_ADD_ORDER = "PlanAddOrder";
        public static readonly string CODE_MASTER_MRP_OPTION_VALUE_SAFESTOCK_ONLY = "SafeStockOnly";
        ...
        public static readonly string ORDERTRACER_TRACERTYPE_LAN = "Plan";
        #endregion

        public static readonly string ENTITY_PREFERENCE_CODE_PERCENTPASS_STARTTIME = "PercentPassStartTime";
        public static readonly string ENTITY_PREFERENCE_CODE_PERCENTPASS_FLOWCODE = "PercentPassFlowCode";
        public static readonly string ENTITY_PREFERENCE_CODE_RESISTANCE_FLOWCODE = "ResistanceFlowCode";
        public static readonly string ENTITY_PREFERENCE_CODE_PERCENTPASS_TRENCH = "PercentPassTrench";

        public static readonly string ENTITY_PREFERENCE_CODE_DEBUGMODE = "DebugMode";
        public static readonly string ENTITY_PREFERENCE_CODE_DEBUGMODEEMAIL = "DebugModeEmail";

        public static readonly string PERMISSION_PAGE_VALUE_PERCENTPASSREP = "PercentPassRep";
        public static readonly string PERMISSION_PAGE_VALUE_OVERPOREP = "OverPORep";
        public static readonly string PERMISSION_PAGE_VALUE_OVERWOREP = "OverWORep";
        public static readonly string PERMISSION_PAGE_VALUE_OVERSOREP = "OverSORep";
        public static readonly string PERMISSION_PAGE_VALUE_OVERTOREP = "OverTORep";
        public static readonly string PERMISSION_PAGE_VALUE_OVERASNREP = "OverASNRep";
        public static readonly string PERMISSION_PAGE_VALUE_UNPCYCREP = "UnpCycRep";
